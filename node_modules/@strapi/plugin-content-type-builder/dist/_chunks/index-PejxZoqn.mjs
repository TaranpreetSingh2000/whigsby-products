...
const ListView$1 = lazy(() => import("./ListView-fQ3FA3pX.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-fQ3FA3pX.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-PejxZoqn.mjs.map
